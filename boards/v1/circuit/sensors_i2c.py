...
I2C-B (N657 I2C2, 400kHz, pull-ups 4.7k -> 3V3_SYS in compute.py):
  ...
  0x39  TCS3448    # VERIFY addr (TCS3448 DS n/a; AS7343 DS p5 = 0x39)  OPTICAL
  0x74  AS7331     VERIFIED-DS p43 (1110_1,A1,A0; A1A0=00)              OPTICAL
  0x64  AS7421     # VERIFY addr (DS unavailable)   OPTICAL domain
...
def build_sensors_i2c():
    ...
    # TCS3448 0x39 (# VERIFY addr — TCS3448 DS unavailable; family anchor:
    # AS7343 ordering table, AS7343 DS p5, lists I2C addr 0x39)
    vis = dev(TCS3448, "U_TCS", v_opt, sda_b, scl_b,
              "generated:TCS3448_OLGA8")
