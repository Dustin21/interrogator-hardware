# USR-3 electrical resolution packet — XM125

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/XM125.yaml`
...
|---|---|---|
| part_number | XM125 (A121) | vendor ordering info |
| vendor | Acconeer | — |
| wire_token | XM125 | upstream command contract |
...
| datasheet (AssetPin) | TODO | `registry_assets/XM125/datasheet/` |
