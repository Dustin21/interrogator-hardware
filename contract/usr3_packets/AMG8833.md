# USR-3 electrical resolution packet — AMG8833

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/AMG8833.yaml`
...
|---|---|---|
| part_number | AMG8833 (Grid-EYE) | vendor ordering info |
| vendor | Panasonic | — |
| wire_token | AMG8833 | upstream command contract |
...
| datasheet (AssetPin) | TODO | `registry_assets/AMG8833/datasheet/` |
