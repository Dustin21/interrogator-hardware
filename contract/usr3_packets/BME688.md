# USR-3 electrical resolution packet — BME688

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/BME688.yaml`
...
|---|---|---|
| part_number | BME688 | vendor ordering info |
| vendor | Bosch Sensortec | — |
| wire_token | BME688 | upstream command contract |
...
| datasheet (AssetPin) | BST-BME688-DS000-03 Rev 1 | `registry_assets/BME688/datasheet/` |
