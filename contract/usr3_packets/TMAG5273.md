# USR-3 electrical resolution packet — TMAG5273

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/TMAG5273.yaml`
...
|---|---|---|
| part_number | TMAG5273 | vendor ordering info |
| vendor | Texas Instruments | — |
| wire_token | TMAG5273 | upstream command contract |
...
| datasheet (AssetPin) | TODO | `registry_assets/TMAG5273/datasheet/` |
