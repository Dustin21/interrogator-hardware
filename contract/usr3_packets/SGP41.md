# USR-3 electrical resolution packet — SGP41

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/SGP41.yaml`
...
|---|---|---|
| part_number | SGP41 | vendor ordering info |
| vendor | Sensirion | — |
| wire_token | SGP41 | upstream command contract |
...
| datasheet (AssetPin) | TODO | `registry_assets/SGP41/datasheet/` |
