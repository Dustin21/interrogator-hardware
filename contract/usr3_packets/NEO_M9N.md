# USR-3 electrical resolution packet — NEO_M9N

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/NEO_M9N.yaml`
...
|---|---|---|
| part_number | NEO-M9N | vendor ordering info |
| vendor | u-blox | — |
| wire_token | GPS | upstream command contract |
...
| datasheet (AssetPin) | TODO | `registry_assets/NEO-M9N/datasheet/` |
