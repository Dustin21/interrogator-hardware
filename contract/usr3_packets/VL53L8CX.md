# USR-3 electrical resolution packet — VL53L8CX

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/VL53L8CX.yaml`
...
|---|---|---|
| part_number | VL53L8CX | vendor ordering info |
| vendor | STMicroelectronics | — |
| wire_token | VL53L8CX | upstream command contract |
...
| datasheet (AssetPin) | TODO | `registry_assets/VL53L8CX/datasheet/` |
