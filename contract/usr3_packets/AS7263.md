# USR-3 electrical resolution packet — AS7263

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/AS7263.yaml`
...
|---|---|---|
| part_number | AS7263 | vendor ordering info |
| vendor | ams OSRAM | — |
| wire_token | AS7263 | upstream command contract |
...
| datasheet (AssetPin) | TODO | `registry_assets/AS7263/datasheet/` |
