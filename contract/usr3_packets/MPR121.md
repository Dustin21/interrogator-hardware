# USR-3 electrical resolution packet — MPR121

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/MPR121.yaml`
...
|---|---|---|
| part_number | MPR121 | vendor ordering info |
| vendor | NXP Semiconductors | — |
| wire_token | MPR121 | upstream command contract |
...
| datasheet (AssetPin) | TODO | `registry_assets/MPR121/datasheet/` |

Upstream `needs`: USR-3: placement conflict -- inventory CSV lists I2C CH6 on Board A; record_schema.md relays MPR121 off-mux from Board C; embedded-SME to resolve (R1)
