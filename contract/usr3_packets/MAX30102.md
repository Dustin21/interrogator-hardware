# USR-3 electrical resolution packet — MAX30102

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/MAX30102.yaml`
...
|---|---|---|
| part_number | MAX30102 | vendor ordering info |
| vendor | Maxim Integrated (ADI) | — |
| wire_token | MAX30102 | upstream command contract |
...
| datasheet (AssetPin) | TODO | `registry_assets/MAX30102/datasheet/` |
