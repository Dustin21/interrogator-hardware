# USR-3 electrical resolution packet — AS7343

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/AS7343.yaml`
...
|---|---|---|
| part_number | AS7343 | vendor ordering info |
| vendor | ams OSRAM | — |
| wire_token | AS7343 | upstream command contract |
...
| datasheet (AssetPin) | TODO | `registry_assets/AS7343/datasheet/` |
