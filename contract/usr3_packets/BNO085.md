# USR-3 electrical resolution packet — BNO085

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/BNO085.yaml`
...
|---|---|---|
| part_number | BNO085 | vendor ordering info |
| vendor | Bosch Sensortec (CEVA/Hillcrest) | — |
| wire_token | BNO085 | upstream command contract |
...
| datasheet (AssetPin) | TODO | `registry_assets/BNO085/datasheet/` |
