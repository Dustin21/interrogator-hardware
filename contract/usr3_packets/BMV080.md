# USR-3 electrical resolution packet — BMV080

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/BMV080.yaml`
...
|---|---|---|
| part_number | BMV080 | vendor ordering info |
| vendor | Bosch Sensortec | — |
| wire_token | BMV080 | upstream command contract |
...
| datasheet (AssetPin) | TODO | `registry_assets/BMV080/datasheet/` |
