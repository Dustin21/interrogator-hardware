# USR-3 electrical resolution packet — AS7331

> DRAFT proposal for `facets.electrical` of `shared/schemas/sensors/AS7331.yaml`
...
|---|---|---|
| part_number | AS7331 | vendor ordering info |
| vendor | ams OSRAM | — |
| wire_token | AS7331 | upstream command contract |
...
| datasheet (AssetPin) | TODO | `registry_assets/AS7331/datasheet/` |
